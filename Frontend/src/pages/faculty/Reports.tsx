                  ...
                  <Table>
                    ...
                    <TableBody>
                      {studentPerformance?.length === 0 ? (
                        ...
                        studentPerformance?.map((s: StudentPerformance, i: number) => (
                          <TableRow key={i}>
                            <TableCell className="font-mono">{s.student_id}</TableCell>
                            <TableCell>{s.name}</TableCell>
                            <TableCell>{s.course}</TableCell>
                            <TableCell>{s.year_level}</TableCell>
                            <TableCell className={s.average_grade !== undefined && s.average_grade <= 3.0 ? "text-green-600" : "text-red-600"}>
                              {s.average_grade !== undefined ? s.average_grade.toFixed(2) : "N/A"}
                            </TableCell>
                  ...
                  <Table>
                    ...
                    <TableBody>
                      {attendanceReport?.length === 0 ? (
                        ...
                        attendanceReport?.map((a: AttendanceReport, i: number) => (
                          <TableRow key={i}>
                    ...
                    <Table>
                      ...
                      <TableBody>
                        {violationSummary?.recent_violations?.length === 0 ? (
                          ...
                          violationSummary?.recent_violations?.map((v: ViolationSummary, i: number) => (
                            <TableRow key={i}>
                              ...
                              <TableCell>{v.violation_date ? new Date(v.violation_date).toLocaleDateString() : 'N/A'}</TableCell>
                            </TableRow>
                          ))
                        )}
                      </TableBody>
                    ...
                    <Table>
                      ...
                      <TableBody>
                        {achievementSummary?.recent_achievements?.length === 0 ? (
                          ...
                          achievementSummary?.recent_achievements?.map((a: AchievementSummary, i: number) => (
                            <TableRow key={i}>
                              ...
                              <TableCell>{a.achievement_date ? new Date(a.achievement_date).toLocaleDateString() : 'N/A'}</TableCell>
                            </TableRow>
                          ))
                        )}
                      </TableBody>
